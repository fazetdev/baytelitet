  ...
  const resources = [
    {
      ...
      items: [
        { titleEn: 'Dubai Land Department (English)', titleAr: 'دائرة الأراضي بدبي (الإنجليزية)', url: 'https://www.dubailand.gov.ae/en/', descriptionEn: 'Main portal for all property services', descriptionAr: 'البوابة الرئيسية لخدمات العقارات' },
